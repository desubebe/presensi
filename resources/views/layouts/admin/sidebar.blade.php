          ...
          <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{ request()->is(['siswa','jurusan','guru','cabang','rombel']) ? 'show' : '' }}" href="#navbar-base"  
                  data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" 
                  aria-expanded="{{ request()->is(['siswa','jurusan','guru','dudi']) ? 'true' : '' }}">
                ...
                <div class="dropdown-menu {{ request()->is(['siswa','jurusan','guru','cabang','rombel']) ? 'show' : '' }}">
                  <div class="dropdown-menu-columns">
                    ...
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item {{ request()->is(['jurusan']) ? 'active' : '' }}" href="/jurusan">
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-arrows-double-se-nw" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                          ...
                          <path d="M14 17v4h-4"></path>
                          <path d="M14 3h-4v4"></path>
                          <path d="M21 14l-11 -11"></path>
                       </svg>
                        Data Jurusan
                      </a>
                    </div>
                    ...
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item {{ request()->is(['rombel']) ? 'active' : '' }}" href="/rombel">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle {{ request()->is(['laporan','rekap']) ? 'show' : '' }}"href="#navbar-base" data-bs-toggle="dropdown" 
                ...
                <div class="dropdown-menu {{ request()->is(['presensi/laporan','presensi/rekap']) ? 'show' : '' }}">
                  <div class="dropdown-menu-columns">
                    ...
                    <li class="nav-item dropdown">
                      ...
                      "{{ request()->is(['lokasikantor']) ? 'show' : '' }} href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button" 
                      aria-expanded="{{ request()->is(['lokasikantor']) ? 'true' : '' }}" >
                        <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/package -->
                      ...
                      <div class="dropdown-menu {{ request()->is(['konfigurasi/lokasikantor']) ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                          <div class="dropdown-menu-column">
                            <a class="dropdown-item {{ request()->is(['konfigurasi/karyawan']) ? 'active' : '' }}" href="/konfigurasi/lokasikantor">
                              <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-map-pin-cog" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                <path d="M9 11a3 3 0 1 0 6 0a3 3 0 0 0 -6 0"></path>
                                <path d="M12.005 21.485a1.994 1.994 0 0 1 -1.418 -.585l-4.244 -4.243a8 8 0 1 1 13.634 -5.05"></path>
                                <path d="M19.001 19m-2 0a2 2 0 1 0 4 0a2 2 0 1 0 -4 0"></path>
                                <path d="M19.001 15.5v1.5"></path>
                                <path d="M19.001 21v1.5"></path>
                                <path d="M22.032 17.25l-1.299 .75"></path>
                          ...
                          <li class="nav-item {{ request()->is(['presensi/izinsakit']) ? 'show' : '' }}">
